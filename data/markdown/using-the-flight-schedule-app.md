...
![Advanced settings: Theme, Layout, Time format, Use screen's local time and Page speed](https://support.optisigns.com/hc/article_attachments/55669107975059)
  ...
  * **Board colors** _(Custom theme only)_ \- Set each part of the board yourself: header background, row background, alternating row, labels and accent, main text, secondary text, and the on-time, delayed and cancelled colors. Reset board colors puts them all back.
