...
Under **Send to** , select a destination icon. For more information on these, see Destinations below. Each one opens as a card you fill in and then select **Done** on. Once you have added one, the remaining destinations appear under **Add more:**
